...
class HighResolutionNet(nn.Module):
    ...
    def init_weights(self, train=False):
        ...
        if train==True:
            ...
            print("Successfully load pre_trained parameters for HR_Net")
        else:
            print('please check HRNET ImageNet pretrained model, the path ' + ' is wrong')
            exit()

def get_seg_model(train=True):
